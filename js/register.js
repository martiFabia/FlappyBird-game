...
//check uguaglianza password e conferma_password 
...
function validateUsername() {
    ...
    //sintassi giusta, controllo la presenza nel db 
    else {
...
//invio richiesta ajax per controllo di username nel db 
...
function goTo(choise){
    if(choise === 'reg'){
        ...
        document.getElementById('FlappyBird').classList.add('hidden');
